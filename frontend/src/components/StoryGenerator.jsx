 ...
 *
 * Main component for generating interactive stories based on user-provided themes.
 * Handles the complete story generation workflow including:
 * - Theme input collection
 * - API communication for story creation
 * - Job status polling for async story generation
 * - Error handling and user feedback
 * - Navigation to completed stories
 *
 * @component
 * @returns {JSX.Element} The story generator interface
 */
